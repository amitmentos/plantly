...
if ($_SESSION["user_type"] == 'farmer') {
  $query = "SELECT * FROM plant WHERE user_id = '" . $_SESSION["user_id"] . "'";
}
if ($cat != 'All') {
  if ($cat == 'avg') {
  ...
  <main class="main">
    <div class="side-menu">
      ...
      <section class="userTool"><a href="contactUs.php"><i class="fa fa-address-book-o" aria-hidden="true"></i>Contact
          us</a><br><a href="#"><i class="fa fa-cog" aria-hidden="true"></i><span data-bs-toggle="modal" data-bs-target="#editModalProfile">Settings</span></a><br><a id="logout" href="login.php"><i
    ...
    <table class="table" id="myTable">
      <thead>
        <tr>
          <th scope="col"></th>
          <th scope="col">Date <button class="sort-button btn" data-column="_date"><i class="fa fa-sort-amount-asc"
                aria-hidden="true"></i></button></th>
          <th scope="col" id="colName">Name <button class="sort-button btn" data-column="plant_name"><i
                class="fa fa-sort-amount-asc" aria-hidden="true"></i></button></th>
          ...
          <th class="responsive-cols" scope="col" id="colLevel">Level <button class="sort-button btn"
              data-column="urgency"><i class="fa fa-sort-amount-asc" aria-hidden="true"></i></button></th>
          <th class="responsive-cols" scope="col" id="colType">Plant Type<button class="sort-button btn"
              data-column="_type"><i class="fa fa-sort-amount-asc" aria-hidden="true"></i></button> </th>
