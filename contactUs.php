...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["name"]) && isset($_POST["email"]) && isset($_POST["subject"]) && isset($_POST["message"])) {
        ...
        $query = "INSERT INTO contactUs (user_id, subject, messages) VALUES (?, ?, ?)";
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control border-0 px-4" placeholder="Subject"
                                            name="subject" style="height: 55px;" required>
                                    </div>
                                    <div class="col-12">
                                        <textarea class="form-control border-0 px-4 py-3" rows="8" name="message"
                                            placeholder="Message"></textarea required>
                                    </div>
                                    <div class="col-12">
