...
$sql = "SELECT advices.*, plant.plant_name 
        FROM advices 
        INNER JOIN plant ON advices.case_id = plant.case_id";
...
$sql = "SELECT COUNT(*) AS penaltyCount FROM plant WHERE user_id = $farmer_id_penalty";
$result = mysqli_query($connection, $sql);
if (!$result) {
    header("Location: login.php");
    die("DB query failed.");
...
<body class="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link selectedNav" href="casesList.php">Cases
                                    <?php if ($_SESSION["user_type"] == "farmer") {
                            ...
                            <li class="nav-item logOutToggle">
                                <a id="logout" href="login.php"><i class="fa fa-sign-out"
    ...
    <main>
        ...
        <div class="side-menu">
            ...
            <section class="userTool"><a href="contactUs.php"><i class="fa fa-address-book-o"
                        aria-hidden="true"></i>Contact us</a><br><a href="#"><i class="fa fa-cog"
                        aria-hidden="true"></i><span data-bs-toggle="modal"
                        data-bs-target="#editModalProfile">Settings</span></a><br><a id="logout" href="login.php"><i
        ...
        <section id="penaltyUpdatedP" class="<?php echo $dataUpdatedClass; ?>">Penalties updated successfully!!
        </section>
                        ...
                        <div class="modal-body">
                            <form action="#" method="GET" id="frm">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <textarea class="form-control" id="description" name="newDescription"
                                        placeholder="More details..." required></textarea>
                                </div>

                                <div class="form-outline mb-4">
                                    <label class="form-label">Panelty Amount:</label>
                                    <input type="number" class="form-control" name="paneltyAmount" placeholder="$" min=1
                                        required>
                                </div>
        ...
        <div class="container">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                $dueDate = new DateTime($row["_date"]);
